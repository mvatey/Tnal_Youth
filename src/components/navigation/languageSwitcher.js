...
export default function LanguageSwitcher() {
  ...
  return (
    <button
      onClick={toggleLang}
      className="flex h-11 items-center gap-1 rounded-full border border-border bg-white p-1 hover:shadow-sm transition-shadow"
      aria-label="ប្ដូរភាសា"
    >
      {/* KM side */}
      <span
      ...
      >
        {lang === "km" && (
          <span className="h-4 w-6 shrink-0 overflow-hidden rounded-sm border border-border">
