...
export default function CertificateCard({
 ...
 const activityBranch =
  ...
  activity?.branch?.nameKh ||
  activity?.branch?.name_en ||
  activity?.branch?.nameEn ||
  activity?.branchName ||
  (typeof activity?.branch === "string" ? activity.branch : "");
...
return (
  <div className="flex w-full justify-center py-4">
    ...
    >
      ...
      {/* Certificate content */}
      <div className="relative z-10 flex h-full flex-col items-center p-10 text-center">
        <Image
          src="/logo.png"
        ...
        <h1
          className={`mt-4 font-bold tracking-wide ${sizeStyle.title}`}
          style={{ color: TEXT_COLOR }}
        >
        ...
        <p
          className="mt-1 text-sm font-medium tracking-[0.2em]"
          style={{ color: TEXT_COLOR }}
        >
          {isKhmer
