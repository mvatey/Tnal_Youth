  ...
  return (
    <div className="flex min-h-[calc(100vh-110px)] min-w-0 flex-col gap-5 lg:flex-row">
      ...
      {showModal && (
        ...
        >
          <div className="no-scrollbar max-h-[calc(100vh-1.5rem)] w-full max-w-[580px] overflow-y-auto rounded-xl bg-bg-page-white shadow-2xl sm:max-h-[90vh]">
      ...
      {showRateModal && (
        ...
        >
          <div className="no-scrollbar max-h-[calc(100vh-1.5rem)] w-full max-w-[480px] overflow-y-auto rounded-xl bg-bg-page-white shadow-2xl sm:max-h-[90vh]">
