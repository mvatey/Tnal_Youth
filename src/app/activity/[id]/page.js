...
export default async function ActivityDetailPage({
   ...
   * canManage:
   *
   * TRUE only for Secretary /
   * Branch Leader belonging to
   * the HOST branch.
   *
   * Only host staff can:
  ...
  /*
   * Backend participant endpoint
   * is branch scoped for staff.
   *
   * Host staff:
   * → host branch participants.
   *
   * Invited staff:
   * → own invited branch.
   */
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between">
         ...
         * IMPORTANT:
         *
         * ONLY HOST BRANCH can edit
         * Activity information.
         *
         * Invited branch does NOT
         * get this button.
         */}
        {canManage && (
          <Link
        ...
        {!isMember && (
          <div className="rounded-xl border border-border bg-bg-page-white p-5">
            ...
            <div className="mt-5 grid grid-cols-2 gap-3">
              {/*
               * Income remains visible.
               *
               * Invited branch may still
               * access Income according to
               * your current flow.
               */}
              <Link
                href={{
