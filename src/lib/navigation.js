...
export const NAV_ITEMS = [
  ...
  { id: 'branches',   label: 'សាខា',             href: '/branch',   icon: 'building',  roles: ['admin'] },
  ...
  { id: 'donations',  label: 'ហិរញ្ញវត្ថុ',          href: '/donation',  icon: 'donation',  roles: ['admin', 'secretary', 'branch_leader', 'member'] },
